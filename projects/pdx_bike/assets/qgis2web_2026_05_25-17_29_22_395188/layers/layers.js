...
lyr_OpenStreetMap_0.setVisible(true);lyr_BikeShareServiceArea_1.setVisible(true);lyr_BikeMapRecommendedRoutes_2.setVisible(true);lyr_BiketownSegments_3.setVisible(true);lyr_Difference_4.setVisible(false);
...
lyr_BiketownSegments_3.set('fieldLabels', {'name': 'no label', 'count': 'no label', 'len': 'no label', 'veh_ms': 'no label', 'GEOID': 'no label', 'geoid_nam': 'no label', 'OBJECTID_1': 'no label', 'StreetName': 'inline label - always visible', 'Recommend': 'inline label - always visible', 'Vehicle Km': 'inline label - always visible', });

...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-13654836.854468, 5701269.622600, -13647061.079810, 5709817.580697], maxZoom: 28, minZoom: 10
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-13654836.854468, 5701269.622600, -13647061.079810, 5709817.580697], map.getSize());

...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-13826977.217233, 5536139.688742, -13478329.269419, 5876902.986802], maxZoom: 28, minZoom: 11
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-13826977.217233, 5536139.688742, -13478329.269419, 5876902.986802], map.getSize());

...
One of the main tools I used to plan my trip was Workaway. For those unfamiliar, [workaway.info](https://www.workaway.info/) is a site that connects hosts and travelers from around the world for work exchanges. Hosts list their projects or businesses on the Workaway platform, and travelers (workawayers) can reach out to hosts to volunteer part time work in exchange for accommodation. There are lots of Workaway options for those traveling to prime destinations in Europe, Latin America, Southeast Asia, etc. In Central Asia, the options are much more limited. I did three Workaways during my time there, but the first was by far the most memorable.
